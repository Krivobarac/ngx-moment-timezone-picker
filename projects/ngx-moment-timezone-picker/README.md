...
For older version see [moment-timezone-picker](https://www.npmjs.com/package/moment-timezone-picker)
...
## Notice
Take care this is a temporary package based on moment-timezone-picker from Roman Yanush, for use in angular version 12. When the original package is upgraded on [location](https://www.npmjs.com/package/moment-timezone-picker) this one will be depricated and then deleted!
